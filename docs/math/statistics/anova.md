...
![Several F distribution density curves are plotted for different numerator and denominator degrees of freedom.](https://commons.wikimedia.org/wiki/Special:FilePath/F-distribution_pdf.svg)
