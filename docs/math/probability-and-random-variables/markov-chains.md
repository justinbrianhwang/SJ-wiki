...
flowchart LR
  ...
  subgraph Evolution["Distribution evolution"]
    direction TB
    Mu0["initial distribution<br/>mu_0 = #lsqb;P(R), P(S)"]"] --> Pmat["transition matrix<br/>P = #lsqb;#lsqb;0.5, 0.5"], ["0.2, 0.8"]]"]
  ...
  subgraph Absorb["Absorbing-chain template"]
    direction TB
    Canon["reorder states<br/>transient first, absorbing last"] --> Block["block matrix<br/>P = #lsqb;#lsqb;Q, R"], ["0, I"]]"]
