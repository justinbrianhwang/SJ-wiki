...
![An eigenvector is shown preserving its direction while being scaled by a matrix.](https://commons.wikimedia.org/wiki/Special:FilePath/Eigenvalue_equation.svg)
